...
export const GITHUB_REPO_URL = 'https://github.com/AkiraCheeckbox/vscode-background-cover';
export const GITHUB_ISSUES_URL = 'https://github.com/AkiraCheeckbox/vscode-background-cover/issues';
