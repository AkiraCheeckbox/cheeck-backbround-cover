...
export const GITHUB_REPO_URL = 'https://github.com/AkiraCheeckbox/cheeck-backbround-cover';
export const GITHUB_ISSUES_URL = 'https://github.com/AkiraCheeckbox/cheeck-backbround-cover/issues';
